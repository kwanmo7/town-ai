 ...
 *
 * <p>Text Message와 Postback 중 하나의 Payload만 존재한다. Reply Token과 원본
 * Webhook Body는 비동기 처리에 필요하지 않으므로 포함하지 않는다.</p>
 *
 ...
 * @param messageText Text Message 원문. Postback이면 {@code null}
 * @param postbackData Postback Data. Text Message이면 {@code null}
